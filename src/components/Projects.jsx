          ...
          {projects.map((project, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div 
                    className={`rounded-3xl overflow-hidden card-hover h-full flex flex-col cursor-pointer transition-colors ${
                  ...
                  >
                    ...
                    >
                      {project.image ? (
                        ...
                        <img 
                          src={project.media[0].media_url.startsWith('http') ? project.media[0].media_url : `http://localhost:5000${project.media[0].media_url}`} 
                          alt={project.title}
                          className="w-full h-full object-cover"
                        />
                      ) : (
            ...
            >
              ...
              <div className="overflow-y-auto max-h-[calc(90vh-60px)]">
                ...
                {selectedProject.media && selectedProject.media.length > 0 ? (
                    ...
                    <div className="aspect-video bg-black flex items-center justify-center">
                      <img
                        src={selectedProject.media[currentMediaIndex].media_url.startsWith('http') 
                          ...
                          : `http://localhost:5000${selectedProject.media[currentMediaIndex].media_url}`}
                    ...
                    {selectedProject.media.length > 1 && (
                      <>
                        <button
                          ...
                          className={`absolute left-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-black/50 text-white transition-opacity ${
                        ...
                        <button
                          ...
                          className={`absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-black/50 text-white transition-opacity ${
                            currentMediaIndex === selectedProject.media.length - 1 ? 'opacity-30 cursor-not-allowed' : 'hover:bg-black/70'
                          }`}
                        >
                    ...
                    {selectedProject.media.length > 1 && (
                      <div className={`flex gap-2 p-3 overflow-x-auto ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
                        {selectedProject.media.map((media, index) => (
                          ...
                          >
                            <img
                              src={media.media_url.startsWith('http') ? media.media_url : `http://localhost:5000${media.media_url}`}
                  ...
                  <div className="aspect-video bg-black flex items-center justify-center">
                    <img
                      src={selectedProject.image.startsWith('http') ? selectedProject.image : `http://localhost:5000${selectedProject.image}`}
